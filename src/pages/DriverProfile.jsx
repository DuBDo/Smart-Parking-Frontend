...
function DriverProfile() {
    ...
    useEffect(() => {
        if (firstName !== fName || lastName !== lName || mobile !== phone || email !== eAddr) {
            setChange(true);
        } else {
            setChange(false);
        }
    ...
    const handleChanges = async () => {
        ...
        try {
            const response = await axios.patch(`${import.meta.env.VITE_BACKEND_URL}/api/V1/driver/account`,
                data,
                {
                    headers: {
        ...
        <div className="flex">
            ...
            <div className="bg-[#f8fbfb] py-10 flex-1 px-52">
                <div className="bg-white rounded shadow-md shadow-gray-400 py-9 px-10">
                    ...
                    <p className="mt-3 text-[#999999] text-[15px]">You can edit your Smart Park profile information below. Clicking on the reset password button will send OTP to your email.</p>

                    <div className="mt-6 flex justify-between">
                        {/* first name  */}
                        <div className="flex flex-col">
                            <label htmlFor="firstName" className="text-[#666666] font-medium">First Name</label>
                        ...
                        {/* SurName   */}
                        <div className="flex flex-col">
                            <label htmlFor="lastName" className="text-[#666666] font-medium">Last Name</label>
                    ...
                    <div className="mt-6 flex justify-between">
                        <div className="flex flex-col">
                            <label htmlFor="mobile" className="text-[#666666] font-medium">Mobile number</label>
                    ...
                    <div className="mt-6 flex justify-between">
                        <div className="flex flex-col">
                            <label htmlFor="email" className="text-[#666666] font-medium">Email address</label>
                            <div className="flex">
                                ...
                                />
                                <button className="w-20 ml-3 py-2.5 px-2.5 font-medium text-[#212121] text-lg border border-[#808080] rounded-md focus:outline-0 cursor-pointer"
                    ...
                    <div className="mt-6 mb-6 flex">
                        <div className="flex flex-col w-full">
                            <label htmlFor="resetPassword" className="text-[#666666] font-medium">
                                Password
                            </label>
                    ...
                    {success && <p className="text-[#24cd6a]">Your profile information has been updated successfully</p>}
                </div>
