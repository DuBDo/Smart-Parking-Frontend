...
const SearchNavBar = () => {
  ...
  const authLinks = [{ path: "", label: user.firstName, isDropdown: true }];
  ...
  return (
    <nav className="shadow-md sticky top-0 z-100 bg-[#21303e]">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-8 flex justify-between items-center h-20">
        {/* Logo */}
        <Link to="/home" className="text-3xl font-extrabold text-white">
          Smart<span className="font-bold text-white">Park</span>
        </Link>
        ...
        <div className="hidden md:flex space-x-8 items-center">
          {navLinks.map((link) =>
            link.isDropdown ? (
              ...
              >
                <div className="text-base flex items-center gap-2 space-x-1">
